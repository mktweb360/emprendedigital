...
export const posts: Post[] = [
  ...
  },
  {
    ...
    title: "HOLLUDLE Silla Ergonómica: análisis completo y opiniones 2025",
    excerpt:
      "Análisis detallado de la HOLLUDLE: qué la diferencia de otras sillas ergonómicas, para quién es la inversión correcta y sus puntos débiles reales.",
    date: "2025-07-02",
    category: "Home Office",
    readTime: "8 min",
    relatedProducts: ["sihoo-m57-silla-ergonomica", "hbada-silla-ergonomica-pro"],
  ...
  },
  {
    ...
    excerpt:
      "Análisis del Logitech MX Keys S: por qué es el teclado más recomendado para home office, sus limitaciones reales y si justifica su precio.",
    date: "2025-07-10",
    category: "Productividad",
    readTime: "7 min",
