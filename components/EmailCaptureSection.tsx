        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-xl font-semibold text-blue-300 mb-4">
              Kit gratuito: 50 herramientas para emprender
            </p>
            <p className="text-white/70 text-base mb-6">
              Las mejores herramientas de productividad, diseño, marketing y gestión — muchas gratuitas. Seleccionadas por profesionales del emprendimiento digital.
            </p>
            <p className="text-white/40 text-sm">⭐ +1.900 emprendedores ya lo usan</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/90 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm"
                />
              </div>
              <div>
                <label className="block text-white/75 text-sm font-medium mb-1.5">
              ...
              <button
                ...
                className="w-full bg-blue-500 hover:bg-blue-400 text-white font-bold py-3.5 px-6 rounded-xl transition-colors text-sm disabled:opacity-60"
              >
                {status === "loading" ? "Enviando…" : "Descargar el kit gratis →"}
              </button>
